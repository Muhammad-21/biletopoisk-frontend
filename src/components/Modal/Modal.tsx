...
export const Modal: React.FC<ModalProps> = ({ onClose, filmId }) => {
        ...
        <div className={styles.modal__overlay} onClick={handleOverlayClick}>
          <div className={styles.modal__content} onClick={handleModalClick}>
            ...
            <div className={styles.modal__bottom}>
              ...
              <button
                className={`${styles.modal__btn} ${styles['modal__btn-outline']}`}
                onClick={onClose}
              >
                Нет
              </button>
  ...
  return <>{open && createPortal(renderModal(), document.body)}</>;
};